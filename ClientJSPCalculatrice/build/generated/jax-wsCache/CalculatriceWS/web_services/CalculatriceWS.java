...
public interface CalculatriceWS {
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "Add", targetNamespace = "http://Web_Services/", className = "web_services.Add")
    @ResponseWrapper(localName = "AddResponse", targetNamespace = "http://Web_Services/", className = "web_services.AddResponse")
    public int add(
